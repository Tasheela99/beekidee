...
const routes: Routes = [
  ...
  {path:'admin',loadComponent:()=>import('./components/console-context/console-context.component').then(c => c.ConsoleContextComponent),canActivate:[AuthGuard],children:[
      ...
      {path:'dashboard',loadComponent:()=>import('./components/console-dashboard/console-dashboard.component').then(c => c.ConsoleDashboardComponent),children:[
          ...
          {path:'overview',loadComponent:()=>import('./components/console-dashboard/components/dashboard/dashboard.component').then(c => c.DashboardComponent)},
